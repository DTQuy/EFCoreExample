    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOrderProduct", x => new { x.UserOrderId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_UserOrderProduct_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserOrderProduct_UserOrder_UserOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOrderProduct_ProductId",
                table: "UserOrderProduct",
                column: "ProductId");
        }
